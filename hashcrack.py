...
try:
    ...
    def hash_md5():
        #open wordlist
        with open(wordlist_location, 'r',errors="ignore") as f:
...
"""))
        parser.add_argument("hash",default="",help="Hash to crack")
...
""")
    ...
    print('-'*50)
    print("{:<10}   {:<}".format("[+]Hash:",hash_input))
    print("{:<10}   {:<}".format("[+]Mode:", mode))
    print("{:<8}    {:<}".format("[+]Wordlist",wordlist_location))
